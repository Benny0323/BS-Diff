...
validate_file_list = "test_set.txt"  # 存储测试集文件名的文本文件
...
for epoch in range(n_epochs):
    ...
    for step, batch in progress_bar:
        ...
        loss_g = recons_loss + kl_weight * kl_loss + perceptual_weight * p_loss + adv_weight * generator_loss + ms_ssim_weight * msssim_loss
